...
export class ListReferenceTypesComponent implements OnInit {
  ...
  public getList(event?:PageEvent){
    ...
    this.apiService.getPageList('/tipos-referencias',false,sidx,sort,index,rows)
    .subscribe(res => {
      this.length = res.records;
      this.dataSource.data = res.rows as ReferenceTypes[];
    })
  }
  ...
  public sortData(sort: Sort) {
    ...
    this.apiService.getPageList('/tipos-referencias',false,sort.direction,sort.active,index,rows)
    .subscribe(res => {
      this.length = res.records;
      this.dataSource.data = res.rows as ReferenceTypes[];
    })
