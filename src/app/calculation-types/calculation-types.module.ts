...
import { CalculationTypesRoutingModule } from './calculation-types-routing.module';
...
@NgModule({
  ...
  declarations: [
    AddCalculationTypesComponent,
    EditCalculationTypesComponent,
    ListCalculationTypesComponent,
    ViewCalculationTypesComponent
    //CanAccessDirective,
    //ShowAuthedDirective
  ],
  providers: [
...
export class CalculationTypesModule {}
