...
import { OutlaysTypesRoutingModule } from './outlays-types-routing.module';
...
@NgModule({
  ...
  declarations: [
    AddOutlaysTypesComponent,
    EditOutlaysTypesComponent,
    ListOutlaysTypesComponent,
    ViewOutlaysTypesComponent
    //CanAccessDirective,
    //ShowAuthedDirective
  ],
  providers: [
...
export class OutlaysTypesModule {}
