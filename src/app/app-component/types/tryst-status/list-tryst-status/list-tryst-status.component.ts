...
@Component({
  selector: 'app-list-tryst-status',
  templateUrl: './list-tryst-status.component.html',
  styleUrls: ['./list-tryst-status.component.scss']
})
export class ListTrystStatusComponent implements AfterViewInit {
    ...
    merge(this.sort.sortChange, this.paginator.page, fromEvent(this.filterInput.nativeElement, 'keyup'))
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.apiService.getPageList('/estado-citas',this.isfilter,this.filterInput.nativeElement.value, this.rulesColumns,
