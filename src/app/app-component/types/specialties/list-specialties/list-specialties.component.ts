...
export class ListSpecialtiesComponent implements AfterViewInit {
    ...
    merge(this.sort.sortChange, this.paginator.page, fromEvent(this.filterInput.nativeElement, 'keyup'))
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.apiService.getPageList('/especialidades',this.isfilter,this.filterInput.nativeElement.value, this.rulesColumns,
