...
@Component({
  selector: 'app-view-compromise',
  templateUrl: './view-compromise.component.html',
  styleUrls: ['./view-compromise.component.css']
})
export class ViewCompromiseComponent implements OnInit {
  myForm: FormGroup;
