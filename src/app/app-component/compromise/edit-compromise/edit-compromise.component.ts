...
@Component({
  selector: 'app-edit-compromise',
  templateUrl: './edit-compromise.component.html',
  styleUrls: ['./edit-compromise.component.scss']
})
export class EditCompromiseComponent implements OnInit{
  myForm: FormGroup;
