...
@Component({
  selector: 'app-list-userspb',
  templateUrl: './list-userspb.component.html',
  styleUrls: ['./list-userspb.component.scss']
})
export class ListUserspbComponent implements AfterViewInit {
