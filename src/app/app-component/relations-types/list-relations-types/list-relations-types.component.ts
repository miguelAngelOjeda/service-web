...
export class ListRelationsTypesComponent implements OnInit {
    ...
    merge(this.sort.sortChange, this.paginator.page)
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.apiService.getPageList('/tipos-vinculos',false,"",this.sort.direction,this.sort.active,
