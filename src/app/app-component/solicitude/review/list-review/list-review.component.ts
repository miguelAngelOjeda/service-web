...
export class ListReviewComponent implements OnInit {
  ...
  public displayedColumns = ['id','propuestaSolicitud.id','propuestaSolicitud.fechaPresentacion','fechaInicioAnalisis','fechaFinAnalisis',  'funcionarioAnalisis.persona.primerNombre' , 'propuestaSolicitud.montoSolicitadoOriginal', 'propuestaSolicitud.sucursal.nombre', 'estado.nombre', 'opciones'];
