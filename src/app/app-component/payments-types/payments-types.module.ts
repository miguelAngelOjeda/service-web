...
import { PaymentsTypesRoutingModule } from './payments-types-routing.module';
...
@NgModule({
  ...
  declarations: [
    AddPaymentsTypesComponent,
    EditPaymentsTypesComponent,
    ListPaymentsTypesComponent,
    ViewPaymentsTypesComponent
    //CanAccessDirective,
    //ShowAuthedDirective
  ],
  providers: [
